...
<body>
    ...
    <div class="container">
        <form action="transaction.php" method="POST">
            <div class="row">
                <h1 style="text-align: center;">Transfer Money Here..!!</h1>
            </div>
            <div class="row">
                <div class="col-25">
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="text" id="receiver_acc_no" name="receiver" placeholder="Enter Receiver's Account No." required>
                </div>
            </div>
            <div class="row">
                <div class="col-25">
            ...
            <div class="row">
                <div class="col-75">
                    <button type="submit" id="btn" name="transfer">Transfer</button>
